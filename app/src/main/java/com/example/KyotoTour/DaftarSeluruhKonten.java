...
public class DaftarSeluruhKonten {
    ...
    public List<ItemModel> listDataFestival() {
        List<ItemModel> listModel = new ArrayList<>();
        listModel.add(new ItemModel(R.drawable.kaoimatsuri, "Aoi Matsuri (Musim Semi)", R.string.des_aoimatsuri, R.string.lok_aoimatsuri, R.string.aks_aoimatsuri, R.string.wak_aoimatsuri, R.string.fee_aoimatsuri, R.string.dae_aoimatsuri, R.string.link_aoimatsuri, R.string.kor_aoimatsuri));
        listModel.add(new ItemModel(R.drawable.kgionmatsuri, "Gion Matsuri (Musim Panas)", R.string.des_gionmatsuri, R.string.lok_gionmatsuri, R.string.aks_gionmatsuri, R.string.wak_gionmatsuri, R.string.fee_gionmatsuri, R.string.dae_gionmatsuri, R.string.link_gionmatsuri, R.string.kor_gionmatsuri));
        listModel.add(new ItemModel(R.drawable.kjidaimatsuri, "Jidai Matsuri (Musim Gugur)", R.string.des_jidaimatsuri, R.string.lok_jidaimatsuri, R.string.aks_jidaimatsuri, R.string.wak_jidaimatsuri, R.string.fee_jidaimatsuri, R.string.dae_jidaimatsuri, R.string.link_jidaimatsuri, R.string.kor_jidaimatsuri));
        return listModel;
    }
}