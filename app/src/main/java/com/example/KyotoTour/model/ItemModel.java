...
public class ItemModel {
    ...
    private String idListkor;
    private int idListGambar, idListDeskripsi, idListlok, idListaks, idListwak, idListfee, idListdae, idListlink;
    private String idListNama;

    public ItemModel(int idListGambar, String idListNama, int idListDeskripsi, int idListlok, int idListaks, int idListwak, int idListfee, int idListdae, int idListlink, String idListkor) {
    ...
    public String getIdListkor() { return idListkor; }

    public void setIdListkor(String idListkor) { this.idListkor = idListkor; }
}
