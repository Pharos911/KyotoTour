...
public class TampilkanIsiKonten extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mengggunakan int karena pemanggilan id. pada fungsi intent tidak perlu menulis string dengan panjang
        ...
        // Solusi Error Kordinat untuk Latitude dan Longitude hasilnya null
        // Penyebab Karena "idKor" di Line 63 itu dari Resource yang pada dasarnya itu INT (alamat datanya)
        // harus ngambil dulu dari alamat datanya Resource tersebut pake fungsi yg di buat di line 83 :
        ...
        this.latlng = this.getResources().getString(idKor);
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        googleMaps.addMarker(new MarkerOptions().position(latLng).title((judul.getText().toString())));
